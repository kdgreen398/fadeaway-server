...
const FETCH_BARBER_DETAILS_BY_PUBLIC_ID = `
  ...
  WHERE PUBLIC_ID = ?
`;
const FETCH_SERVICES_BY_BARBER_ID = `SELECT SERVICE_ID, NAME, DESCRIPTION, LENGTH, PRICE FROM SERVICES WHERE BARBER_ID = ?`;
...
const CREATE_SERVICE = `INSERT INTO SERVICES (NAME, LENGTH, DESCRIPTION, PRICE, BARBER_ID) VALUES (?, ?, ?, ?, ?)`;
